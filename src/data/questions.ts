import type { ComplaintDefinition, ComplaintId, Question } from "@/types"

/**
 * Demo adaptive question bank.
 *
 * The opening question is always the same; the follow-up set is chosen by the
 * chief complaint the patient picks. Every option carries the machine-readable
 * signals that `utils/redFlags.ts` evaluates, so the triage rules never parse
 * free text.
 *
 * This whole module is the seam for the backend: `clinicalService.getFollowUps`
 * will eventually return the same shape from a FastAPI/LLM endpoint, and no
 * component needs to change.
 */

export const CHIEF_COMPLAINT_QUESTION: Question = {
...
export const COMPLAINTS: Record<ComplaintId, ComplaintDefinition> = {
  "chest-pain": {
    id: "chest-pain",
    label: { en: "Chest pain or tightness", hi: "छाती में दर्द या जकड़न" },
    ...
    followUps: [
      {
        ...
        prompt: {
          ...
          hi: "छाती का दर्द कब शुरू हुआ?",
        },
        options: [
          {
            id: "cp-onset-now",
            label: { en: "Just now", hi: "अभी-अभी" },
            signals: ["onset-sudden"],
          },
          {
            id: "cp-onset-hours",
            label: { en: "A few hours ago", hi: "कुछ घंटे पहले" },
            signals: ["onset-recent"],
          },
          { id: "cp-onset-yesterday", label: { en: "Yesterday", hi: "कल" } },
          {
            id: "cp-onset-days",
            label: { en: "Several days ago", hi: "कई दिन पहले" },
          },
        ],
      },
      {
        ...
        options: [
          {
            id: "cp-loc-centre",
            label: { en: "Centre of chest", hi: "छाती के बीच में" },
            signals: ["pain-central"],
          },
          { id: "cp-loc-left", label: { en: "Left side", hi: "बाईं तरफ" } },
          { id: "cp-loc-right", label: { en: "Right side", hi: "दाईं तरफ" } },
          {
            id: "cp-loc-behind",
            label: { en: "Behind the chest", hi: "छाती के पीछे" },
            signals: ["pain-central"],
          },
        ],
      },
      {
        ...
        prompt: {
          ...
          hi: "क्या दर्द हाथ, जबड़े या पीठ तक फैलता है?",
        },
        options: [
          {
            id: "cp-rad-arm",
            label: { en: "Yes, to arm", hi: "हाँ, हाथ तक" },
            signals: ["radiation-arm"],
          },
          {
            id: "cp-rad-jaw",
            label: { en: "Yes, to jaw", hi: "हाँ, जबड़े तक" },
            signals: ["radiation-jaw"],
          },
          {
            id: "cp-rad-back",
            label: { en: "Yes, to back", hi: "हाँ, पीठ तक" },
            signals: ["radiation-back"],
          },
          {
            id: "cp-rad-none",
            label: { en: "No, stays in chest", hi: "नहीं, केवल छाती में" },
            signals: ["no-radiation"],
          },
        ],
      },
      {
        ...
        kind: "single",
        prompt: {
          en: "Is there sweating or breathlessness with the pain?",
          hi: "क्या दर्द के साथ पसीना या सांस फूलना है?",
        },
        options: [
          {
            id: "cp-assoc-sweating",
            label: { en: "Yes, heavy sweating", hi: "हाँ, बहुत पसीना" },
            signals: ["diaphoresis"],
          },
          {
            id: "cp-assoc-breathless",
            label: { en: "Yes, breathlessness", hi: "हाँ, सांस फूलना" },
            signals: ["breathless-at-rest"],
          },
          {
            id: "cp-assoc-both",
            label: { en: "Both", hi: "दोनों" },
            signals: ["diaphoresis", "breathless-at-rest"],
          },
    ...
    followUps: [
      {
        ...
        kind: "single",
        prompt: {
          en: "When did the breathing difficulty start?",
          hi: "सांस की तकलीफ कब शुरू हुई?",
        },
        options: [
          {
            id: "br-onset-sudden",
            label: { en: "Suddenly, within the hour", hi: "अचानक, एक घंटे के अंदर" },
            signals: ["onset-sudden"],
          },
          {
            id: "br-onset-today",
            label: { en: "Earlier today", hi: "आज पहले" },
            signals: ["onset-recent"],
          },
      ...
      },
      {
        ...
        kind: "single",
        prompt: {
          en: "When are you short of breath?",
          hi: "आपको कब सांस फूलती है?",
        },
        options: [
          {
            id: "br-trig-rest",
            label: { en: "Even while resting", hi: "आराम करते समय भी" },
            signals: ["breathless-at-rest"],
          },
          {
            id: "br-trig-exertion",
            label: { en: "Only on walking or effort", hi: "चलने या मेहनत पर" },
            signals: ["breathless-on-exertion"],
          },
      ...
      },
      {
        ...
        kind: "single",
        prompt: {
          en: "Is there chest pain, sweating or blue lips?",
          hi: "क्या छाती में दर्द, पसीना या होंठ नीले हैं?",
        },
        options: [
          {
            id: "br-assoc-chest",
            label: { en: "Yes, chest pain", hi: "हाँ, छाती में दर्द" },
            signals: ["pain-central"],
          },
          {
            id: "br-assoc-sweat",
            label: { en: "Yes, sweating", hi: "हाँ, पसीना" },
            signals: ["diaphoresis"],
          },
    ...
    followUps: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "fv-grade-high",
            label: { en: "Very high with chills", hi: "बहुत तेज़, ठंड लगकर" },
            signals: ["high-fever"],
          },
      ...
      },
      {
        ...
        kind: "single",
        prompt: {
          en: "Any neck stiffness, rash or confusion?",
          hi: "क्या गर्दन में अकड़न, दाने या भ्रम है?",
        },
        options: [
          {
            id: "fv-assoc-neck",
            label: { en: "Yes, neck stiffness", hi: "हाँ, गर्दन में अकड़न" },
            signals: ["neck-stiffness"],
          },
          { id: "fv-assoc-rash", label: { en: "Yes, rash", hi: "हाँ, दाने" } },
          {
            id: "fv-assoc-confusion",
            label: { en: "Yes, confusion or drowsiness", hi: "हाँ, भ्रम या सुस्ती" },
            signals: ["speech-difficulty"],
          },
    ...
    followUps: [
      {
        ...
        options: [
          {
            id: "hd-onset-thunderclap",
            label: {
              en: "Suddenly — worst headache of my life",
              hi: "अचानक — अब तक का सबसे तेज़ दर्द",
            },
            signals: ["onset-sudden", "worst-ever-headache"],
          },
          {
            id: "hd-onset-hours",
            label: { en: "Built up over hours", hi: "कुछ घंटों में बढ़ा" },
            signals: ["onset-recent"],
          },
      ...
      },
      {
        ...
        kind: "single",
        prompt: {
          en: "Any weakness, slurred speech or loss of vision?",
          hi: "क्या कमजोरी, बोलने में कठिनाई या दृष्टि हानि है?",
        },
        options: [
          {
            id: "hd-neuro-weakness",
            label: { en: "Weakness on one side", hi: "एक तरफ कमजोरी" },
            signals: ["focal-weakness"],
          },
          {
            id: "hd-neuro-speech",
            label: { en: "Slurred or difficult speech", hi: "बोलने में कठिनाई" },
            signals: ["speech-difficulty"],
          },
          {
            id: "hd-neuro-vision",
            label: { en: "Sudden vision loss", hi: "अचानक दृष्टि हानि" },
            signals: ["vision-loss"],
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "hd-sev-severe",
            label: { en: "Severe — hard to bear", hi: "बहुत तेज़ — सहन नहीं होता" },
            signals: ["severe-pain"],
          },
        ],
      },
    ...
    followUps: [
      {
        ...
        options: [
          {
            id: "ab-onset-sudden",
            label: { en: "Suddenly, very severe", hi: "अचानक, बहुत तेज़" },
            signals: ["onset-sudden", "severe-pain"],
          },
          {
            id: "ab-onset-hours",
            label: { en: "A few hours ago", hi: "कुछ घंटे पहले" },
      ...
      },
      {
        ...
        kind: "single",
        prompt: {
          en: "Any vomiting of blood or black stools?",
          hi: "क्या खून की उल्टी या काला मल है?",
        },
        options: [
          {
            id: "ab-bleed-vomit",
            label: { en: "Yes, blood in vomit", hi: "हाँ, उल्टी में खून" },
            signals: ["vomiting-blood"],
          },
          {
            id: "ab-bleed-stool",
            label: { en: "Yes, black stools", hi: "हाँ, काला मल" },
            signals: ["black-stools"],
          },
    ...
    followUps: [
      {
        ...
        kind: "single",
        prompt: {
          en: "Which of these is closest to your problem?",
          hi: "इनमें से कौन आपकी समस्या के सबसे करीब है?",
        },
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: "ot-sev-severe",
            label: { en: "Severely", hi: "बहुत अधिक" },
            signals: ["severe-pain"],
          },
        ],
      },
...
export function isComplaintId(value: string): value is ComplaintId {
  return COMPLAINT_IDS.includes(value as ComplaintId)
}

export function getComplaint(id: ComplaintId): ComplaintDefinition {
