...
const en = {
  ...
  "landing.brandTagline": "AI for a kinder healthcare",
  "landing.nav.opd": "A Smarter OPD",
  "landing.nav.how": "How It Works",
  "landing.nav.patients": "For Patients",
  "landing.nav.vision": "Our Vision",
  "landing.doctorLogin": "Doctor Login",
  "landing.eyebrow": "LISTENING • UNDERSTANDING • SUPPORTING",
  "landing.headline1": "Your health story,",
  "landing.headline2": "heard.",
  "landing.subtitle":
    "ClinSutra helps you share your symptoms, medical history and documents through a simple conversation before you meet your doctor.",
  "landing.cta": "Start Consultation",
  "landing.ctaHint": "Speak naturally or use touch — it's easy and secure.",
  "landing.feature.voice.title": "AI-Powered Conversation",
  "landing.feature.voice.sub": "Speak in your language",
  "landing.feature.docs.title": "Upload Documents",
  "landing.feature.docs.sub": "Prescriptions, reports and more",
  "landing.feature.secure.title": "Secure & Private",
  "landing.feature.secure.sub": "Your information stays safe",
  "landing.how.title": "How It Works",
  "landing.how.step1": "Tell us what's bothering you — by voice or touch.",
  "landing.how.step2": "Answer a few simple follow-up questions.",
  "landing.how.step3": "Add prescriptions or reports if you have them.",
  "landing.how.step4": "Your doctor reviews it all before you meet.",
  "landing.vision.title": "Our Vision",
  "landing.vision.body":
    "Shorter waits, calmer visits, and a doctor who already knows your story. ClinSutra brings warmth and understanding to every OPD conversation.",
  "landing.footer.motto": "Made for people. Built with AI. Rooted in care.",
  "landing.footer.privacy": "Privacy",
  "landing.footer.terms": "Terms",
  "landing.footer.contact": "Contact",
  "landing.footer.rights": "© 2026 ClinSutra. All rights reserved.",
  "landing.heroCardTagline": "A healthier tomorrow together",
  ...
  "patientId.validationAge": "Please enter a valid age between 1 and 120.",
  "patientId.validationPhone": "Please enter a valid 10-digit mobile number.",
...
const hi: Record<TranslationKey, string> = {
  ...
  "landing.brandTagline": "एक दयालु स्वास्थ्य सेवा के लिए AI",
  "landing.nav.opd": "स्मार्ट OPD",
  "landing.nav.how": "यह कैसे काम करता है",
  "landing.nav.patients": "रोगियों के लिए",
  "landing.nav.vision": "हमारा दृष्टिकोण",
  "landing.doctorLogin": "डॉक्टर लॉगिन",
  "landing.eyebrow": "सुनना • समझना • सहारा देना",
  "landing.headline1": "आपकी सेहत की बात,",
  "landing.headline2": "सुनी गई।",
  "landing.subtitle":
    "ClinSutra आपको डॉक्टर से मिलने से पहले एक सरल बातचीत के ज़रिए अपने लक्षण, चिकित्सा इतिहास और दस्तावेज़ साझा करने में मदद करता है।",
  "landing.cta": "परामर्श शुरू करें",
  "landing.ctaHint": "स्वाभाविक रूप से बोलें या टच करें — यह आसान और सुरक्षित है।",
  "landing.feature.voice.title": "AI-संचालित बातचीत",
  "landing.feature.voice.sub": "अपनी भाषा में बोलें",
  "landing.feature.docs.title": "दस्तावेज़ अपलोड करें",
  "landing.feature.docs.sub": "पर्चे, रिपोर्ट और अधिक",
  "landing.feature.secure.title": "सुरक्षित और निजी",
  "landing.feature.secure.sub": "आपकी जानकारी सुरक्षित रहती है",
  "landing.how.title": "यह कैसे काम करता है",
  "landing.how.step1": "बताएं कि आपको क्या तकलीफ़ है — बोलकर या टच करके।",
  "landing.how.step2": "कुछ आसान अनुवर्ती प्रश्नों के उत्तर दें।",
  "landing.how.step3": "यदि आपके पास पर्चे या रिपोर्ट हों तो जोड़ें।",
  "landing.how.step4": "आपका डॉक्टर मिलने से पहले सब कुछ देख लेता है।",
  "landing.vision.title": "हमारा दृष्टिकोण",
  "landing.vision.body":
    "कम इंतज़ार, शांत मुलाक़ातें, और एक डॉक्टर जो पहले से आपकी बात जानता है। ClinSutra हर OPD बातचीत में गर्मजोशी और समझ लाता है।",
  "landing.footer.motto": "लोगों के लिए बनाया गया। AI से निर्मित। देखभाल में निहित।",
  "landing.footer.privacy": "गोपनीयता",
  "landing.footer.terms": "शर्तें",
  "landing.footer.contact": "संपर्क",
  "landing.footer.rights": "© 2026 ClinSutra. सर्वाधिकार सुरक्षित।",
  "landing.heroCardTagline": "साथ मिलकर एक स्वस्थ कल",
  ...
  "patientId.validationAge": "कृपया 1 से 120 के बीच एक मान्य आयु दर्ज करें।",
  "patientId.validationPhone": "कृपया एक मान्य 10-अंकीय मोबाइल नंबर दर्ज करें।",
